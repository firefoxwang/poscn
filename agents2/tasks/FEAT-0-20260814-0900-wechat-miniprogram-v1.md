...
| Stage 3 MP 鉴权路由 | T3.1/T3.2 | untested | `NEW-0-20260814-1400-mp-stage3-auth-routes.md`（里程碑闭环） |
...
| Stage 6 Web 端入口 | T6.1/T6.2 | untested | `NEW-0-20260814-1400-mp-stage6-web-entry.md` |
| Stage 7 商户端小程序 | T7.1–T7.4 | untested | `NEW-0-20260814-1400-mp-stage7-merchant-mp.md` |
| Stage 8 消费者端小程序 | T8.1–T8.4 | untested | `NEW-0-20260814-1400-mp-stage8-consumer-mp.md` |
| Stage 9 文档与收尾 | T9.1/T9.2 | untested | `NEW-0-20260814-1400-mp-stage9-docs.md` |