...
from .mp_dashboard_routes import router as mp_dashboard_router
from .mp_qrcode_routes import router as mp_qrcode_router
...
app.include_router(mp_dashboard_router, prefix="/mp/dashboard", tags=["Mini program dashboard"])
app.include_router(mp_qrcode_router, prefix="/mp", tags=["Mini program QR"])
