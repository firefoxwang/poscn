...
def test_normalize_defaults_to_cny():
    assert normalize_tenant_currency_fields(None, None) == ("CNY", "¥")
    assert normalize_tenant_currency_fields("", "$") == ("CNY", "¥")
